...
export const FirebaseProvider = ({ children }) => {
    ...
    useEffect(() => {
        if (userId) {
            ...
            // FETCH ALL DEPOSIT REQUESTS (from all users)
            const depositRequestCollectionRef = collectionGroup(db, "depositRequests");
            ...
            const unsubscribeSnapshot3 = onSnapshot(
              ...
              (error) => {
                console.error("Error fetching depositRequests:", error);
              }
            );
